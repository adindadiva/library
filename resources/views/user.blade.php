...
<head>
	...
	<!-- Themify -->
	<link rel="stylesheet" href="{{ asset('style/plugins/themify/css/themify-icons.css') }} ">
	<link rel="stylesheet" href="{{ asset('style/plugins/slick-carousel/slick-theme.css') }}">
	<link rel="stylesheet" href="{{ asset('style/plugins/slick-carousel/slick.css') }}">
	<!-- Slick Carousel -->
	<link rel="stylesheet" href="{{ asset('style/plugins/owl-carousel/owl.carousel.min.css') }}">
	<link rel="stylesheet" href="{{ asset('style/plugins/owl-carousel/owl.theme.default.min.css') }}">
	<link rel="stylesheet" href="{{ asset('style/plugins/magnific-popup/magnific-popup.css') }}">
	<!-- manin stylesheet -->
...
================================================== -->
	...
	<script src="{{ asset('style/plugins/jquery/jquery.js') }}"></script>
	<!-- Bootstrap jQuery -->
	<script src="{{ asset('style/plugins/bootstrap/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset('style/plugins/bootstrap/js/popper.min.js') }}"></script>
	<!-- Owl caeousel -->
	<script src="{{ asset('style/plugins/owl-carousel/owl.carousel.min.js') }}"></script>
	<script src="{{ asset('style/plugins/slick-carousel/slick.min.js') }}"></script>
	<script src="{{ asset('style/plugins/magnific-popup/magnific-popup.js') }}"></script>
	<!-- Instagram Feed Js -->
	<script src="{{ asset('style/plugins/instafeed-js/instafeed.min.js') }}"></script>
	<!-- Google Map -->
